...
<h1>Создание и просмотр заявок</h1>
<div class="b-text">
	...
	<br>
	<p>При выборе аэропорта пунктом прибытия или отправления становятся доступными поля «Рейс «Туда» и «Рейс «Обратно» (Рисунок 7), которые заполняются аналогично пункту прибытия и отправления.</p>
	<br>
	...
	<br>
	<p>Пункт прибытия выбирается тем же способом. После выбора пункта отправления и пункта прибытия выполняется расчёт стоимости проезда (Рисунок 8).</p>
	<br>
	...
	<br>
	<p>Дата в поле «Дата/время выезда» заполняется либо вводом с клавиатуры, либо с помощью выпадающего календаря (Рисунок 9). Серым цветом подсвечивается текущая дата. Чёрным цветом – выбранная дата (Рисунок 10). Ввод времени в поле «Дата/время выезда» осуществляется с клавиатуры.</p>
	<br>
	...
	<br>
	<p>Количество пассажиров указывается в поле «Количество пассажиров». Для добавления или удаления пассажиров необходимо нажать на кнопку «Удалить» или «Добавить пассажира» соответственно (Рисунок 11). После добавления или удаления пассажира происходит перерасчет стоимости.</p>
	<br>
	...
	<br>
	<p>После того, как будут заполнены все обязательные поля, появится возможность создать заявку (Рисунок 4). По нажатию на кнопку «Оформить заявку» будет создана заявка и появится соответствующее сообщение (Рисунок 12). После этого произойдет переход на страницу со списком всех заявок.</p>
	<br>
	<a href="<?php echo Yii::app()->request->baseUrl; ?>/i/help/12.jpg" class="fancy-img"><img src="<?php echo Yii::app()->request->baseUrl; ?>/i/help/12.jpg" alt=""></a>
	<p class="tc">Рисунок 12</p>
	<br>
</div>