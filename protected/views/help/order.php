...
<div class="b-text">
	...
	<br>
	<p>Для добавления заявки необходимо перейти в раздел «Заявки» и нажать кнопку «Добавить заявку», расположенную в правом верхнем углу (Рисунок 1).</p>
	<br>
	...
	<br>
	<p>При выборе аэропорта пунктом прибытия или отправления становятся доступными поля «Рейс «Туда»» и «Рейс «Обратно»» (Рисунок 8), которые заполняются аналогично пункту прибытия и отправления.</p>
	<br>
