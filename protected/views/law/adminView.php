...
<div class="clearfix b-two-cols">
	...
	<div class="b-col">
		...
		<? if( Yii::app()->user->checkAccess('updateAll') ): ?><a href="<?php echo $this->createUrl("/note/adminCreate", array("item_id" => $model->id, "type_id" => 2))?>" class="ajax-form ajax-create b-butt b-top-butt">Добавить</a><? endif; ?>
		<table class="b-table">
			<tr>
				<th><?=$noteLabels["id"]?></th>
